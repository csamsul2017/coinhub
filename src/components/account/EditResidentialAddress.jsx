  ...
  return (
    <div className="flex flex-col w-full gap-8 px-6 py-6 md:w-1/2">
      ...
      <div>
        ...
        <p className="text-muted">Please enter as it's shown on your ID</p>
      </div>
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-8 text-sm">
        <div className="flex flex-col ">
          ...
          <input type="text" onChange={e => setResidentialAddress(e.target.value)} value={residentialAddress} className="p-4 border rounded-md" placeholder="Your address" disabled={isLoading} />
        </div>
